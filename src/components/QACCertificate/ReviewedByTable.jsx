// components/QACCertificate/ReviewedByTable.jsx
import React from 'react';
import { Trash2 } from 'lucide-react';
import { CustomGridTable, GridHeaderCell, GridDataCell, CellInput, ActionCell } from './ReviewedByTableStyle';

export default function ReviewedByTable({ editable, rows, columns, onChange, onDeleteRow }) {
  return (
